...
<div class="masonry" id="imageViewer">
	...
	<div class="brick"><img data-original="<?=GALLERY_URL?>043.jpg" src="<?=GALLERY_URL?>043.jpg" alt="With Ustad Fazal Quershi and Bala Bhaskar"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>044.jpg" src="<?=GALLERY_URL?>044.jpg" alt="At the age of 14 with his father and Guru Sri Sukumar"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>045.jpg" src="<?=GALLERY_URL?>045.jpg" alt="with his childhood friend Ghatam Giridhar Udupa"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>050.jpg" src="<?=GALLERY_URL?>050.jpg" alt="With Stephan Devassy and Giridhar Udupa in Bangkok"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>052.jpg" src="<?=GALLERY_URL?>052.jpg" alt="With R A Ramamani, Keith Peters, Santhosh Mulekar and Kartik Mani"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>053.jpg" src="<?=GALLERY_URL?>053.jpg" alt="With Wouter Kellerman and Music Director Charan Raj"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>063.jpg" src="<?=GALLERY_URL?>063.jpg" alt="With the team Layatharanga at Singapore"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>064.jpg" src="<?=GALLERY_URL?>064.jpg" alt="At a concert with Vidwan Ganesh, Vidwan Kumaresh, Ustad Zakir Hussain and Vidwan Patri Sathish Kumar"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>065.jpg" src="<?=GALLERY_URL?>065.jpg" alt="With Dr. Suma Sudhindra &amp; Pandit Vishwamohan Bhat"></div>
	<div class="brick"><img data-original="<?=GALLERY_URL?>071.jpg" src="<?=GALLERY_URL?>071.jpg" alt="With his friends and members of the band Laya Gharana in Poland"></div>
